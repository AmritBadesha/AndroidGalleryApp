...
public class SearchViewTest {
    ...
    public void searchViewTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.textViewDate),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatTextView2 = onView(
                allOf(withId(R.id.textViewDate2),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.etKeywords),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Sunset"), closeSoftKeyboard());

        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.go), withText("Ok"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
